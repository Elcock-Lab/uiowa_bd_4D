      ...
      subroutine calculate_elec_forces_st_no_newton(n_ll_e_st,
     ...
     &             ene_ll_e_st,fff_ll_e_st,ggg_ll_e_st,mirep)
      ...
      real      :: fff_ll_e_st(1:4,1:num_tot_atms) ! e_a_x_st
      real      :: ggg_ll_e_st(1:4,1:num_tot_atms) ! e_e_x_st
     ...
     &          one_over_one_plus_kappa_rion
            ...
            ene_ll_e_st=ene_ll_e_st+u_v*0.5
