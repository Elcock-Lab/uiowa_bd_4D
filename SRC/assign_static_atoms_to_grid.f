...
C do all current atom positions first
      ...
      do iii=num_mov_atms+1,num_tot_atms ! only use static atoms
...
C make sure that the limits are correctly applied:
        ...
        i3_lic(iii)=i3
        i4_lic(iii)=i4 ! 4D
        cll_f_2(i1,i2,i3,i4,i5)%num=cll_f_2(i1,i2,i3,i4,i5)%num+1
      ...
      do i4=1,num_w_ff
        do i3=1,num_z_ff
          do i2=1,num_y_ff
            do i1=1,num_x_ff
              deallocate(cll_f_2(i1,i2,i3,i4,i5)%ida)
            enddo
          enddo
        enddo
      enddo
      ...
      do i4=1,num_w_ff
        do i3=1,num_z_ff
          do i2=1,num_y_ff
            do i1=1,num_x_ff
              allocate(cll_f_2(i1,i2,i3,i4,i5)%ida
     &                (cll_f_2(i1,i2,i3,i4,i5)%num))
            enddo
          enddo
        enddo
      enddo
      ...
      do iii=num_mov_atms+1,num_tot_atms ! only use static atoms
       cll_f_2(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4_lic(iii),i5)%num=
     & cll_f_2(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4_lic(iii),i5)%num+1
       cll_f_2(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4_lic(iii),i5)%ida(
     & cll_f_2(i1_lic(iii),i2_lic(iii),i3_lic(iii),i4_lic(iii),i5)%num)=
     & iii
      enddo                                           
