      ...
      subroutine calculate_elec_forces_md_newton(n_ll_e_md,n_ll_e_st,
     ...
     &             ene_ll_e_md,fff_ll_e_md,ggg_ll_e_md,mirep)
      ...
      real      :: fff_ll_e_md(1:3,1:num_tot_atms) ! fff_ll_e_md
      real      :: ggg_ll_e_md(1:3,1:num_tot_atms) ! ggg_ll_e_md
     ...
     &          one_over_one_plus_kappa_rion
            ...
            fff_ll_e_md(1,jjj)=fff_ll_e_md(1,jjj)-f_v*w1
            fff_ll_e_md(2,jjj)=fff_ll_e_md(2,jjj)-f_v*w2
            fff_ll_e_md(3,jjj)=fff_ll_e_md(3,jjj)-f_v*w3
            ...
            ggg_ll_e_md(1,jjj)=ggg_ll_e_md(1,jjj)-f_v*w1    
            ggg_ll_e_md(2,jjj)=ggg_ll_e_md(2,jjj)-f_v*w2  
            ggg_ll_e_md(3,jjj)=ggg_ll_e_md(3,jjj)-f_v*w3   
          enddo
        else
          do mmm=1,n_ll_e_md
            iii=ida_ll_e_md(mmm)
