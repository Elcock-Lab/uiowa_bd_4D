...
C this code should work fine for both _st and _md forces
      ...
      subroutine calculate_go_forces_no_newton(n_ll_g_st,
     ...
     &             fff_ll_g_st,mirep)
      ...
      real      :: rep_ll_g_st(1:n_ll_g_st)
      real      :: fff_ll_g_st(1:4,1:num_tot_atms)
      ...
      do mmm=1,n_ll_g_st
        ...
        ene_ll_g_st=ene_ll_g_st+u_v*0.5
        ...
        fff_ll_g_st(4,iii)=fff_ll_g_st(4,iii)+f_v*w4 ! 4D 
      enddo
